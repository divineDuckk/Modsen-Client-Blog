...
export const EN_ABOUT_US_INFO = [
  { info: "Blogs Published", value: "12+" },
  { info: "Views on Finsweet", value: "18K+" },
  { info: "Total active Users", value: "30K+" },
];
export const RU_ABOUT_US_INFO = [
  { info: "Опубликовано блогов", value: "12+" },
  { info: "Просмотры на Finsweet", value: "18K+" },
  { info: "Всего активных пользователей", value: "30K+" },
];
